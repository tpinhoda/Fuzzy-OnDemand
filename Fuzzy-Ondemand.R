...
TRAINING_DATASET = read.csv("~/Data\ Stream/DS_Datasets/Synthetic/Stationary/KDD_99CUP/kdd99cup.csv")[c(TRUE, FALSE), ]
TEST_DATASET = read.csv("~/Data\ Stream/DS_Datasets/Synthetic/Stationary/KDD_99CUP/kdd99cup.csv")[c(FALSE, TRUE), ]
...
MICROCLUSTER_RATIO <- 115      #Quantidade de micro-grupos máxima por classe na criacao inicial
...
KFIT <- 80                  #Quantidade de pontos que serão testadas
...
#------------------------------------------------------Inicializa funcões--------------------------------------------------------------------------------------------
source("~/Data\ Stream/Classifiers/Tiago/Fuzzy-OnDemand/Utils-Fuzzy.R")
